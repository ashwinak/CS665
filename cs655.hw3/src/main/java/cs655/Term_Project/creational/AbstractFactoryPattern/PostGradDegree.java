...
public class PostGradDegree extends Degree {
    private  Map<String, List<String>> PostGrad ;
    String Name;
    public PostGradDegree(Map<String, List<String>> postGrad) {

        PostGrad = postGrad;
    }

    public PostGradDegree() {

    }

    @Override
    public String toString(){
        return "**Creating PostGrad Degree Program**";
    }
